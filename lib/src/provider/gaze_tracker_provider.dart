...
import 'package:flutter_eye_tracking/src/model/app_stage.dart';
import 'package:flutter_eye_tracking/src/model/gazetracker_method_string.dart';

class GazeTrackerProvider with ChangeNotifier {
  dynamic state;
  static const licenseKey =
      'dev_mcfhz5r8r5fzjfz5i1630glsrlhl843rwlmfwlnc'; // Please enter the key value for development issued by the SeeSo.io
